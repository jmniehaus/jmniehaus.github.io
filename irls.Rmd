...
**NOTE:** *The material presented here is not original in the sense that others have already researched this. I am simply reiterating work that has already been done. Please see the the end of the document for supporting references.*
...
Graphically, suppose we select an arbitrary point $x_0$, and draw its corresponding linear approximation to the $f(x)$ as in the process just described:
