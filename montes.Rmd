...
1. To disable _multi-threaded matrix operations_, use the [`RhpcBLASctl`](https://cran.r-project.org/web/packages/RhpcBLASctl/index.html) package, <span style="color: red;">**and be sure to disable multi-threading in your loop code as seen below, not just outside of it:**</span>
