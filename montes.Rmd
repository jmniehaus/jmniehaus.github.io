...
Although this is certainly not a guide on the `foreach` package (see the previous links for more detail on the package), there are a few parameters worth discussing here. 
