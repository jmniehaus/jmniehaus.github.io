...
save(simulation_output, session, file = f)
        ```
<p> </p>
  3. As seen in the previous code block, please store your `sessionInfo()`, particularly if you're sharing the results around computers, or these will need to be replicated in the future. The session info will keep a record of the versions of R and the packages you used in your simulations. 
  
  4. Use lists and data.frames, don't use matrices and vectors. See below for an explanation.
  
  4. Close your parallel backend religiously. 
