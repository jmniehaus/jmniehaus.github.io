...
Using the same example of just adding 1 to each element of a vector, each of these steps for going parallel are implemented in the code below. 
...
<p> </p>
 ...
 <div>
  <details>
  <summary><span style="color: #0888a8;">But I'm on Windows and I want to FORK...</span></summary>
